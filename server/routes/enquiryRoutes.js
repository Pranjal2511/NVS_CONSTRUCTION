...
router.post('/', submissionLimiter, optionalAuth, createEnquiryValidator, validate, enquiryController.createEnquiry);
router.post('/contact', submissionLimiter, optionalAuth, createEnquiryValidator, validate, enquiryController.createContact);
