      ...
      >
        ...
        <div className="bg-brand-surface-high border border-white/8 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-brand-gold px-8 py-6 flex flex-col items-center gap-2">
            ...
            <h1 className="font-display text-[#0a0f18] text-lg font-black uppercase tracking-[0.2em]">Admin Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="admin-email" className="block font-display text-[10px] font-bold uppercase tracking-widest text-brand-on-surface-variant">
                Email
              </label>
            ...
            {/* Password */}
            <div className="space-y-1.5">
              <label htmlFor="admin-password" className="block font-display text-[10px] font-bold uppercase tracking-widest text-brand-on-surface-variant">
                Password
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-3.5 flex items-center text-brand-on-surface-variant/40 pointer-events-none">
